       ...
       <div className='mt-10 '>
        ...
        <p style={{backgroundColor:`${color ? color : "#FF3CAC"}`}}  className='divider w-1/5 mx-auto  h-1 rounded mb-10'/>
         <div className='container mx-auto lg:flex  gap-5 font-serif p-4'>
            <div data-aos="fade-right" data-aos-duration="3000" style={{boxShadow:`1px 1px 1px 2px  ${color ? color : "#FF3CAC"}`}} className="mockup-code bg-black   lg:w-3/5">
           ...
           <a data-aos="fade-left" data-aos-duration="3000" href="https://chef-master-3fdfd.web.app/" target='_blank'>
